...
**Builds on:** [site-ui](../06-site-ui/overview.md), [initiatives](../07-initiatives/overview.md)
...
The [initiatives](../07-initiatives/overview.md) project owns the 07 fork; **groups** adds org-group
...
- `docs/projects/06-site-ui/discussions/orm-pivot-for-ui-queries.md` — original groups ingest (prototype 06)
