...
**Builds on:** [first-version](../../first-version/overview.md) — prototype 10 unchanged
...
- **Page structure** — home sections, join hub, article layouts stay as in [first-version](../../first-version/overview.md).
