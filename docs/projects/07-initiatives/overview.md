...
**Also on this prototype:** [groups](../07-groups/overview.md) — org-group presentation (no separate fork).

**Builds on:** [site-ui](../06-site-ui/overview.md) (prototype 06)
...
[member-journeys](../07-member-journeys/overview.md) project (2026-08-14). Forge activity stays
system-scoped.
...
- `docs/projects/06-site-ui/` — prototype 06 baseline (unchanged)
