...
Surfaced by the [member-journeys](../07-member-journeys/overview.md) project (2026-08-14). Index pages,
home, and detail pages show `recruiting: open`. See
[entry-points-and-conversion.md](../07-member-journeys/discussions/entry-points-and-conversion.md).
...
- Further member-journey work: Join page copy, forge get-involved, article CTAs — see
  [member-journeys](../07-member-journeys/overview.md).
